...
class DashboardController extends GetxController {
  ...
  final List<TypeOfWorkSpaceModelClass> typeOfWorkSpaceModel = [
    TypeOfWorkSpaceModelClass('assest/images/barber_shop_icon.png',
        'Barbershop', AppColors.blueColor.color),
    TypeOfWorkSpaceModelClass('assest/images/tattoo_studio_icon.png',
        'Tattoo Studio', AppColors.buttonColor.color),
    TypeOfWorkSpaceModelClass('assest/images/medical_spa_icon.png',
        'Medical Spa', AppColors.medicalSpaBg.color),
    TypeOfWorkSpaceModelClass('assest/images/beauty_salon_icon.png',
        'Beauty Saloon', AppColors.beautySaloonBg.color),
    TypeOfWorkSpaceModelClass('assest/images/barber_shop_icon.png',
        'Barbershop', AppColors.blueColor.color),
    TypeOfWorkSpaceModelClass('assest/images/tattoo_studio_icon.png',
        'Tattoo Studio', AppColors.buttonColor.color),
  ...
  final List<FeaturedWorkSpaceModelClass> featuredWorkSpaceModel = [
    FeaturedWorkSpaceModelClass('assest/images/standerd_chair.png',
        'High Traffic, standard chair', "Houston, Texas"),
    FeaturedWorkSpaceModelClass('assest/images/dummy_barber_shop_image.png',
        'Four Beauty Saloon', "40 W, New York"),
    FeaturedWorkSpaceModelClass('assest/images/dummy_sallon_shop_image.png',
        'Saloon and Spa', "NY 10011, USA"),
    FeaturedWorkSpaceModelClass('assest/images/dummy_barber_shop_image.png',
        'Beauty Saloon', "NY 10011, USA"),
    FeaturedWorkSpaceModelClass(
        'assest/images/standerd_chair.png', 'Barbershop', "Bangalore-560016"),
    FeaturedWorkSpaceModelClass('assest/images/standerd_chair.png',
        'Unisex Saloon', "Phoenix Mall, Whitefield"),
  ];
